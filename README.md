...
# [Project 1: Streaming data from its source to HDFS using Apache Flume](https://github.com/chinmaya1001/Hadoop/blob/main/flume.coonfig)
...
![The high level Architecture of Apache Flume !](Images/Flume_Architecture.JPG)
